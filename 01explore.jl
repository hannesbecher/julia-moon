...
# ╔═╡ c5f8a0d5-e927-4889-9b54-15c6ef93b614
using Plots

# ╔═╡ 670b04d3-36a3-407e-a6db-9c553780825d
using DataFrames

# ╔═╡ afbcf264-143e-4c84-b0f2-c3dc1a4effc1
using CSV

# ╔═╡ 40d0cfa3-6ef6-45f5-8210-f73f27b573eb
using Dates

# ╔═╡ 0b763623-c88c-4761-8ba7-d1b08b15eff3
using StatsPlots

# ╔═╡ 5003c6fd-0d67-4989-b9eb-0422aa8f2489
using Optim

# ╔═╡ 02ee2c58-c04c-4436-8a6e-8a21a4f6d85e
using PlutoUI

# ╔═╡ f48de4b2-6559-11ee-3420-e783687c9500
md"""
# Packages
"""
...
function decalt(x::AbstractString)
	a=split(x[1:5], "d") 
	parse(Float64, a[1]) + parse(Float64, a[2])/60 
end

# ╔═╡ 7297da96-ca98-4fe5-b665-53f35cc40603
dat.decalt = map(decalt, dat.Alt)
...
# ╔═╡ 3252f532-4759-4bb4-bc9b-cb92287b5936
360/1000/60/60/24

# ╔═╡ aa79daec-92a7-4b26-8a68-4a2318eb726b
300/1000/60/60/24
...
# ╔═╡ de2379f8-24f3-4809-adef-1d342a5053c1
...
# ╔═╡ 30bfc27a-94a0-4104-aac1-98f506341d35
md"""
## Models
"""
...
md"""
Azimuth model assuming constant speed.
"""
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "bfac544ea0a54385a86c105dbfa2abd6c308cc54"
